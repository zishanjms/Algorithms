...
public class DoublyCircularLinkedList {/*
	...
	public void insertBeg(Object data)
	{
		...
		if(last!=null)
		{
			newNode.setFront(last.getFront());
			newNode.setBack(last);
			if(last.getFront()!=null)
			{
				last.getFront().setBack(newNode);
			}
			last.setFront(newNode);
	...
	public static void main(String[] args) {
		DoublyCircularLinkedList circularLinkedList = new DoublyCircularLinkedList();
